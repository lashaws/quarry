/**
 * Monaco's editor contributions, without its 80 language packs.
 *
 * `editor.api` exports the API surface but registers none of these, so an editor
 * built from it silently has no suggest widget, no hover, no find — the actions
 * exist as no-ops. This list is generated from Monaco's own editor.main manifest.
 */
